/**
 * Generates creatine i18n copy/nav/forms for all 16 locales.
...
const LOCALES = ['en','zh-tw','hi','es','ar','fr','bn','pt','ru','ur','id','de','ja','ko','vi','th'];

function assertAll(obj, label) {
  for (const loc of LOCALES) {
    if (!(loc in obj)) throw new Error(`Missing locale ${loc} in ${label}`);
  }
}

function dumpRecord(name, type, obj) {
  assertAll(obj, name);
  const body = LOCALES.map((loc) => {
    return `  '${loc}': ${JSON.stringify(obj[loc], null, 2).replace(/^/gm, '  ').trimStart()},`;
  }).join('\n');
  // Use unquoted keys for en etc where valid - keep quoted for safety
  return `const ${name}: Record<Locale, ${type}> = {\n${LOCALES.map(loc => {
    const key = loc.includes('-') ? `'${loc}'` : loc;
    return `  ${key}: ${serialize(obj[loc], 2)},`;
  }).join('\n')}\n};\n`;
}
...
function serialize(val, indent) {
  ...
  if (Array.isArray(val)) {
    ...
    return `[\n${val.map(v => `${pad2}${serialize(v, indent + 2)},`).join('\n')}\n${pad}]`;
  }
  if (val && typeof val === 'object') {
    const keys = Object.keys(val);
    return `{\n${keys.map(k => `${pad2}${/^[a-zA-Z_$][\w$]*$/.test(k) ? k : JSON.stringify(k)}: ${serialize(val[k], indent + 2)},`).join('\n')}\n${pad}}`;
  }
  return 'null';
}
...
const navRows = {
  home: {
    en:'Home','zh-tw':'首頁',hi:'होम',es:'Inicio',ar:'الرئيسية',fr:'Accueil',bn:'হোম',pt:'Início',ru:'Главная',ur:'ہوم',id:'Beranda',de:'Start',ja:'ホーム',ko:'홈',vi:'Trang chủ',th:'หน้าแรก'
  },
  products: {
    en:'Products','zh-tw':'產品',hi:'उत्पाद',es:'Productos',ar:'المنتجات',fr:'Produits',bn:'পণ্য',pt:'Produtos',ru:'Продукты',ur:'مصنوعات',id:'Produk',de:'Produkte',ja:'製品',ko:'제품',vi:'Sản phẩm',th:'ผลิตภัณฑ์'
  },
  oem: {
    en:'OEM','zh-tw':'OEM',hi:'OEM',es:'OEM',ar:'OEM',fr:'OEM',bn:'OEM',pt:'OEM',ru:'OEM',ur:'OEM',id:'OEM',de:'OEM',ja:'OEM',ko:'OEM',vi:'OEM',th:'OEM'
  },
  wholesale: {
    en:'Wholesale','zh-tw':'批發',hi:'थोक',es:'Mayoreo',ar:'الجملة',fr:'Gros',bn:'হোলসেল',pt:'Atacado',ru:'Опт',ur:'ہول سیل',id:'Grosir',de:'Großhandel',ja:'卸売',ko:'도매',vi:'Bán sỉ',th:'ขายส่ง'
  },
  quality: {
    en:'Quality','zh-tw':'品質',hi:'गुणवत्ता',es:'Calidad',ar:'الجودة',fr:'Qualité',bn:'গুণমান',pt:'Qualidade',ru:'Качество',ur:'کوالٹی',id:'Kualitas',de:'Qualität',ja:'品質',ko:'품질',vi:'Chất lượng',th:'คุณภาพ'
  },
  contact: {
    en:'Contact','zh-tw':'聯絡',hi:'संपर्क',es:'Contacto',ar:'اتصل بنا',fr:'Contact',bn:'যোগাযোগ',pt:'Contato',ru:'Контакты',ur:'رابطہ',id:'Kontak',de:'Kontakt',ja:'お問い合わせ',ko:'문의',vi:'Liên hệ',th:'ติดต่อ'
  },
  quote: {
    en:'Request Quote','zh-tw':'索取報價',hi:'कोट अनुरोध',es:'Solicitar cotización',ar:'طلب عرض سعر',fr:'Demander un devis',bn:'কোট অনুরোধ',pt:'Solicitar orçamento',ru:'Запросить КП',ur:'کوٹ کی درخواست',id:'Minta penawaran',de:'Angebot anfordern',ja:'見積依頼',ko:'견적 요청',vi:'Yêu cầu báo giá',th:'ขอใบเสนอราคา'
  },
  company: {
    en:'Company','zh-tw':'公司',hi:'कंपनी',es:'Empresa',ar:'الشركة',fr:'Entreprise',bn:'কোম্পানি',pt:'Empresa',ru:'Компания',ur:'کمپنی',id:'Perusahaan',de:'Unternehmen',ja:'会社',ko:'회사',vi:'Công ty',th:'บริษัท'
  },
  qualityCompliance: {
    en:'Quality & Compliance','zh-tw':'品質與合規',hi:'गुणवत्ता और अनुपालन',es:'Calidad y cumplimiento',ar:'الجودة والامتثال',fr:'Qualité et conformité',bn:'গুণমান ও সম্মতি',pt:'Qualidade e conformidade',ru:'Качество и соответствие',ur:'کوالٹی اور کمپلائنس',id:'Kualitas & kepatuhan',de:'Qualität & Compliance',ja:'品質・コンプライアンス',ko:'품질 및 컴플라이언스',vi:'Chất lượng & tuân thủ',th:'คุณภาพและการปฏิบัติตาม'
  },
  programs: {
    en:'Programs','zh-tw':'方案',hi:'प्रोग्राम',es:'Programas',ar:'البرامج',fr:'Programmes',bn:'প্রোগ্রাম',pt:'Programas',ru:'Программы',ur:'پروگرامز',id:'Program',de:'Programme',ja:'プログラム',ko:'프로그램',vi:'Chương trình',th:'โปรแกรม'
  },
  allProducts: {
    en:'All products','zh-tw':'全部產品',hi:'सभी उत्पाद',es:'Todos los productos',ar:'جميع المنتجات',fr:'Tous les produits',bn:'সব পণ্য',pt:'Todos os produtos',ru:'Все продукты',ur:'تمام مصنوعات',id:'Semua produk',de:'Alle Produkte',ja:'全製品',ko:'전체 제품',vi:'Tất cả sản phẩm',th:'ผลิตภัณฑ์ทั้งหมด'
  },
  gummies: {
    en:'Creatine Gummies','zh-tw':'肌酸軟糖',hi:'क्रिएटिन गमी',es:'Gomitas de creatina',ar:'علكات الكرياتين',fr:'Gummies créatine',bn:'ক্রিয়েটিন গামি',pt:'Gummies de creatina',ru:'Жевательные креатин',ur:'کریٹائن گمیز',id:'Gummy creatine',de:'Creatin-Gummies',ja:'クレアチン・グミ',ko:'크레아틴 구미',vi:'Kẹo dẻo creatine',th:'ครีเอทีนกัมมี่'
  },
  powder: {
    en:'Creatine Powder','zh-tw':'肌酸粉',hi:'क्रिएटिन पाउडर',es:'Creatina en polvo',ar:'مسحوق الكرياتين',fr:'Créatine en poudre',bn:'ক্রিয়েটিন পাউডার',pt:'Creatina em pó',ru:'Креатин порошок',ur:'کریٹائن پاؤڈر',id:'Bubuk creatine',de:'Creatin-Pulver',ja:'クレアチン粉末',ko:'크레아틴 파우더',vi:'Bột creatine',th:'ครีเอทีนผง'
  },
  capsules: {
    en:'Creatine Capsules','zh-tw':'肌酸膠囊',hi:'क्रिएटिन कैप्सूल',es:'Cápsulas de creatina',ar:'كبسولات الكرياتين',fr:'Capsules de créatine',bn:'ক্রিয়েটিন ক্যাপসুল',pt:'Cápsulas de creatina',ru:'Креатин капсулы',ur:'کریٹائن کیپسولز',id:'Kapsul creatine',de:'Creatin-Kapseln',ja:'クレアチン・カプセル',ko:'크레아틴 캡슐',vi:'Viên nang creatine',th:'ครีเอทีนแคปซูล'
  },
  oemPrivate: {
    en:'OEM / Private Label','zh-tw':'OEM／私標',hi:'OEM / प्राइवेट लेबल',es:'OEM / marca privada',ar:'OEM / علامة خاصة',fr:'OEM / marque blanche',bn:'OEM / প্রাইভেট লেবেল',pt:'OEM / private label',ru:'OEM / private label',ur:'OEM / پرائیویٹ لیبل',id:'OEM / private label',de:'OEM / Private Label',ja:'OEM／プライベートラベル',ko:'OEM / 프라이빗 라벨',vi:'OEM / nhãn riêng',th:'OEM / ไพรเวทเลเบล'
  },
  support: {
    en:'Support','zh-tw':'支援',hi:'सहायता',es:'Soporte',ar:'الدعم',fr:'Support',bn:'সহায়তা',pt:'Suporte',ru:'Поддержка',ur:'سپورٹ',id:'Dukungan',de:'Support',ja:'サポート',ko:'지원',vi:'Hỗ trợ',th:'สนับสนุน'
  },
  oemQuote: {
    en:'OEM Quote','zh-tw':'OEM 報價',hi:'OEM कोट',es:'Cotización OEM',ar:'عرض سعر OEM',fr:'Devis OEM',bn:'OEM কোট',pt:'Orçamento OEM',ru:'КП OEM',ur:'OEM کوٹ',id:'Penawaran OEM',de:'OEM-Angebot',ja:'OEM見積',ko:'OEM 견적',vi:'Báo giá OEM',th:'ใบเสนอราคา OEM'
  },
  wholesalePrice: {
    en:'Wholesale Price List','zh-tw':'批發價目表',hi:'थोक मूल्य सूची',es:'Lista de precios mayoreo',ar:'قائمة أسعار الجملة',fr:'Tarif gros',bn:'হোলসেল মূল্য তালিকা',pt:'Lista de preços atacado',ru:'Оптовый прайс',ur:'ہول سیل قیمت فہرست',id:'Daftar harga grosir',de:'Großhandelspreisliste',ja:'卸売価格表',ko:'도매 가격표',vi:'Bảng giá sỉ',th:'รายการราคาขายส่ง'
  },
  sampleRequest: {
    en:'Sample Request','zh-tw':'索樣',hi:'सैंपल अनुरोध',es:'Solicitud de muestra',ar:'طلب عينة',fr:'Demande d’échantillon',bn:'নমুনা অনুরোধ',pt:'Pedido de amostra',ru:'Запрос образца',ur:'سیمپل کی درخواست',id:'Permintaan sampel',de:'Musteranfrage',ja:'サンプル依頼',ko:'샘플 요청',vi:'Yêu cầu mẫu',th:'ขอตัวอย่าง'
  },
  faq: {
    en:'FAQ','zh-tw':'常見問題',hi:'FAQ',es:'FAQ',ar:'الأسئلة الشائعة',fr:'FAQ',bn:'FAQ',pt:'FAQ',ru:'FAQ',ur:'FAQ',id:'FAQ',de:'FAQ',ja:'FAQ',ko:'FAQ',vi:'FAQ',th:'FAQ'
  },
  terms: {
    en:'Terms','zh-tw':'條款',hi:'नियम',es:'Términos',ar:'الشروط',fr:'Conditions',bn:'শর্তাবলী',pt:'Termos',ru:'Условия',ur:'شرائط',id:'Syarat',de:'AGB',ja:'利用規約',ko:'이용약관',vi:'Điều khoản',th:'ข้อกำหนด'
  },
  privacy: {
    en:'Privacy Policy','zh-tw':'隱私權政策',hi:'गोपनीयता नीति',es:'Política de privacidad',ar:'سياسة الخصوصية',fr:'Politique de confidentialité',bn:'গোপনীয়তা নীতি',pt:'Política de privacidade',ru:'Политика конфиденциальности',ur:'رازداری کی پالیسی',id:'Kebijakan privasi',de:'Datenschutz',ja:'プライバシーポリシー',ko:'개인정보 처리방침',vi:'Chính sách bảo mật',th:'นโยบายความเป็นส่วนตัว'
  },
  footnote: {
    ...
    hi:'<a class="text-primary underline dark:text-accent" href="{home}">Crest Creatine</a> द्वारा · B2B क्रिएटिन OEM और थोक · सर्वाधिकार सुरक्षित।',
...
for (const loc of LOCALES) {
  NAV[loc] = {};
  for (const [k, row] of Object.entries(navRows)) {
    NAV[loc][k] = row[loc];
  }
}
...
// ─── Forms ────────────────────────────────────────────────────
const formLabels = {
  iAmA: {en:"I am a",'zh-tw':'我是',hi:'मैं हूँ',es:'Soy',ar:'أنا',fr:'Je suis',bn:'আমি',pt:'Sou',ru:'Я',ur:'میں ہوں',id:'Saya adalah',de:'Ich bin',ja:'私は',ko:'저는',vi:'Tôi là',th:'ฉันเป็น'},
  lookingFor: {en:"I'm looking for",'zh-tw':'我想了解',hi:'मुझे चाहिए',es:'Busco',ar:'أبحث عن',fr:'Je cherche',bn:'আমি খুঁজছি',pt:'Procuro',ru:'Мне нужно',ur:'میں تلاش کر رہا/رہی ہوں',id:'Saya mencari',de:'Ich suche',ja:'ご用件',ko:'문의 유형',vi:'Tôi cần',th:'ฉันต้องการ'},
  volume: {en:'Expected volume','zh-tw':'預估量',hi:'अपेक्षित मात्रा',es:'Volumen esperado',ar:'الحجم المتوقع',fr:'Volume prévu',bn:'প্রত্যাশিত পরিমাণ',pt:'Volume esperado',ru:'Ожидаемый объём',ur:'متوقع مقدار',id:'Volume yang diharapkan',de:'Erwartetes Volumen',ja:'想定数量',ko:'예상 물량',vi:'Khối lượng dự kiến',th:'ปริมาณที่คาดหวัง'},
  name: {en:'Name','zh-tw':'姓名',hi:'नाम',es:'Nombre',ar:'الاسم',fr:'Nom',bn:'নাম',pt:'Nome',ru:'Имя',ur:'نام',id:'Nama',de:'Name',ja:'お名前',ko:'이름',vi:'Họ tên',th:'ชื่อ'},
  email: {en:'Email','zh-tw':'電子郵件',hi:'ईमेल',es:'Correo',ar:'البريد الإلكتروني',fr:'E-mail',bn:'ইমেইল',pt:'E-mail',ru:'Эл. почта',ur:'ای میل',id:'Email',de:'E-Mail',ja:'メール',ko:'이메일',vi:'Email',th:'อีเมล'},
  message: {en:'Message','zh-tw':'訊息',hi:'संदेश',es:'Mensaje',ar:'الرسالة',fr:'Message',bn:'বার্তা',pt:'Mensagem',ru:'Сообщение',ur:'پیغام',id:'Pesan',de:'Nachricht',ja:'メッセージ',ko:'메시지',vi:'Tin nhắn',th:'ข้อความ'},
  select: {en:'Select…','zh-tw':'請選擇…',hi:'चुनें…',es:'Seleccionar…',ar:'اختر…',fr:'Sélectionner…',bn:'নির্বাচন…',pt:'Selecionar…',ru:'Выберите…',ur:'منتخب کریں…',id:'Pilih…',de:'Auswählen…',ja:'選択…',ko:'선택…',vi:'Chọn…',th:'เลือก…'},
  brand: {en:'Brand','zh-tw':'品牌',hi:'ब्रांड',es:'Marca',ar:'علامة تجارية',fr:'Marque',bn:'ব্র্যান্ড',pt:'Marca',ru:'Бренд',ur:'برانڈ',id:'Merek',de:'Marke',ja:'ブランド',ko:'브랜드',vi:'Thương hiệu',th:'แบรนด์'},
  distributor: {en:'Distributor','zh-tw':'經銷商',hi:'वितरक',es:'Distribuidor',ar:'موزّع',fr:'Distributeur',bn:'ডিস্ট্রিবিউটর',pt:'Distribuidor',ru:'Дистрибьютор',ur:'ڈسٹری بیوٹر',id:'Distributor',de:'Distributor',ja:'代理店',ko:'유통사',vi:'Nhà phân phối',th:'ตัวแทนจำหน่าย'},
  gym: {en:'Gym or retailer','zh-tw':'健身房或零售商',hi:'जिम या रिटेलर',es:'Gimnasio o minorista',ar:'صالة رياضية أو تاجر تجزئة',fr:'Salle de sport ou détaillant',bn:'জিম বা খুচরা বিক্রেতা',pt:'Academia ou varejista',ru:'Зал или ритейл',ur:'جم یا ریٹیلر',id:'Gym atau retailer',de:'Studio oder Einzelhandel',ja:'ジム／小売',ko:'헬스장 또는 리테일',vi:'Phòng gym hoặc bán lẻ',th:'ยิมหรือร้านค้าปลีก'},
  online: {en:'Online seller','zh-tw':'電商賣家',hi:'ऑनलाइन विक्रेता',es:'Vendedor online',ar:'بائع عبر الإنترنت',fr:'Vendeur en ligne',bn:'অনলাইন বিক্রেতা',pt:'Vendedor online',ru:'Онлайн-продавец',ur:'آن لائن فروخت کنندہ',id:'Penjual online',de:'Online-Händler',ja:'ネット販売',ko:'온라인 판매자',vi:'Người bán online',th:'ผู้ขายออนไลน์'},
  other: {en:'Other','zh-tw':'其他',hi:'अन्य',es:'Otro',ar:'أخرى',fr:'Autre',bn:'অন্যান্য',pt:'Outro',ru:'Другое',ur:'دیگر',id:'Lainnya',de:'Sonstiges',ja:'その他',ko:'기타',vi:'Khác',th:'อื่นๆ'},
  oemOpt: {en:'OEM / Private label','zh-tw':'OEM／私標',hi:'OEM / प्राइवेट लेबल',es:'OEM / marca privada',ar:'OEM / علامة خاصة',fr:'OEM / marque blanche',bn:'OEM / প্রাইভেট লেবেল',pt:'OEM / private label',ru:'OEM / private label',ur:'OEM / پرائیویٹ لیبل',id:'OEM / private label',de:'OEM / Private Label',ja:'OEM／プライベートラベル',ko:'OEM / 프라이빗 라벨',vi:'OEM / nhãn riêng',th:'OEM / ไพรเวทเลเบล'},
  wholesaleOpt: {en:'Wholesale pricing','zh-tw':'批發報價',hi:'थोक मूल्य',es:'Precios mayoreo',ar:'أسعار الجملة',fr:'Tarifs gros',bn:'হোলসেল মূল্য',pt:'Preços atacado',ru:'Оптовые цены',ur:'ہول سیل قیمت',id:'Harga grosir',de:'Großhandelspreise',ja:'卸売価格',ko:'도매 가격',vi:'Giá sỉ',th:'ราคาขายส่ง'},
  sampleOpt: {en:'Sample','zh-tw':'樣品',hi:'सैंपल',es:'Muestra',ar:'عينة',fr:'Échantillon',bn:'নমুনা',pt:'Amostra',ru:'Образец',ur:'سیمپل',id:'Sampel',de:'Muster',ja:'サンプル',ko:'샘플',vi:'Mẫu',th:'ตัวอย่าง'},
  bulkPowder: {en:'Bulk powder','zh-tw':'散裝粉',hi:'बल्क पाउडर',es:'Polvo a granel',ar:'مسحوق بالجملة',fr:'Poudre en vrac',bn:'বাল্ক পাউডার',pt:'Pó a granel',ru:'Порошок оптом',ur:'بلک پاؤڈر',id:'Bubuk curah',de:'Bulk-Pulver',ja:'バルク粉末',ko:'벌크 파우더',vi:'Bột số lượng lớn',th:'ผงปริมาณมาก'},
  bulkGummies: {en:'Bulk gummies','zh-tw':'散裝軟糖',hi:'बल्क गमी',es:'Gomitas a granel',ar:'علكات بالجملة',fr:'Gummies en vrac',bn:'বাল্ক গামি',pt:'Gummies a granel',ru:'Жевательные оптом',ur:'بلک گمیز',id:'Gummy curah',de:'Bulk-Gummies',ja:'バルク・グミ',ko:'벌크 구미',vi:'Kẹo dẻo số lượng lớn',th:'กัมมี่ปริมาณมาก'},
  trialMoq: {en:'Trial MOQ','zh-tw':'試產 MOQ',hi:'ट्रायल MOQ',es:'MOQ de prueba',ar:'حد أدنى تجريبي',fr:'MOQ d’essai',bn:'ট্রায়াল MOQ',pt:'MOQ de teste',ru:'Пробный MOQ',ur:'ٹرائل MOQ',id:'MOQ uji coba',de:'Probe-MOQ',ja:'トライアルMOQ',ko:'시험 MOQ',vi:'MOQ thử',th:'MOQ ทดลอง'},
  container: {en:'Container / pallet','zh-tw':'貨櫃／棧板',hi:'कंटेनर / पैलेट',es:'Contenedor / pallet',ar:'حاوية / منصة',fr:'Conteneur / palette',bn:'কন্টেইনার / প্যালেট',pt:'Contêiner / pallet',ru:'Контейнер / паллет',ur:'کنٹینر / پیلیٹ',id:'Kontainer / palet',de:'Container / Palette',ja:'コンテナ／パレット',ko:'컨테이너 / 팔레트',vi:'Container / pallet',th:'ตู้คอนเทนเนอร์ / พาเลท'},
  monthly: {en:'Ongoing monthly','zh-tw':'每月持續',hi:'मासिक निरंतर',es:'Mensual continuo',ar:'شهري مستمر',fr:'Mensuel récurrent',bn:'মাসিক চলমান',pt:'Mensal contínuo',ru:'Ежемесячно',ur:'ماہانہ جاری',id:'Bulanan berkelanjutan',de:'Laufend monatlich',ja:'毎月継続',ko:'월간 지속',vi:'Hàng tháng liên tục',th:'รายเดือนต่อเนื่อง'},
  namePh: {en:'Your name','zh-tw':'您的姓名',hi:'आपका नाम',es:'Su nombre',ar:'اسمك',fr:'Votre nom',bn:'আপনার নাম',pt:'Seu nome',ru:'Ваше имя',ur:'آپ کا نام',id:'Nama Anda',de:'Ihr Name',ja:'お名前',ko:'성함',vi:'Tên của bạn',th:'ชื่อของคุณ'},
  emailPh: {en:'you@company.com','zh-tw':'you@company.com',hi:'you@company.com',es:'usted@empresa.com',ar:'you@company.com',fr:'vous@entreprise.com',bn:'you@company.com',pt:'voce@empresa.com',ru:'you@company.com',ur:'you@company.com',id:'anda@perusahaan.com',de:'sie@firma.com',ja:'you@company.com',ko:'you@company.com',vi:'ban@congty.com',th:'you@company.com'},
  msgPh: {
  ...
  close: {en:'Close','zh-tw':'關閉',hi:'बंद करें',es:'Cerrar',ar:'إغلاق',fr:'Fermer',bn:'বন্ধ',pt:'Fechar',ru:'Закрыть',ur:'بند کریں',id:'Tutup',de:'Schließen',ja:'閉じる',ko:'닫기',vi:'Đóng',th:'ปิด'},
  preferChat: {en:'Prefer chat?','zh-tw':'想用即時通訊？',hi:'चैट पसंद है?',es:'¿Prefiere chat?',ar:'تفضل الدردشة؟',fr:'Préférez le chat ?',bn:'চ্যাট পছন্দ?',pt:'Prefere chat?',ru:'Предпочитаете чат?',ur:'چیٹ پسند ہے؟',id:'Lebih suka chat?',de:'Lieber chat?',ja:'チャット希望？',ko:'채팅을 원하시나요?',vi:'Thích chat hơn?',th:'ชอบแชท?'},
  waTitle: {en:'Chat on WhatsApp','zh-tw':'WhatsApp 聊聊','hi:'WhatsApp पर चैट','es:'Chatear por WhatsApp','ar:'الدردشة عبر واتساب','fr:'Discuter sur WhatsApp','bn:'WhatsApp-এ চ্যাট','pt:'Conversar no WhatsApp','ru:'Чат в WhatsApp','ur:'WhatsApp پر چیٹ','id:'Chat di WhatsApp','de:'Per WhatsApp chatten','ja:'WhatsAppでチャット','ko:'WhatsApp 채팅','vi:'Chat trên WhatsApp','th:'แชทบน WhatsApp'},
  waSubtitle: {
...
fs.writeFileSync(path.join(OUT, '_gen-nav-data.json'), JSON.stringify({ NAV, formLabels }, null, 0));
console.log('Wrote intermediate data');
